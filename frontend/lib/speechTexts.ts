...
export const SPEECH_ENTRIES: SpeechEntry[] = [
  ...
  { text: "포브스 선정 올해 제일 커리어운 좋은 사람", themes: ["career"] },
  ...
  { text: "이 정도면 핵심을 찔렀다", themes: ["career", "study", "health"] },
  { text: "HMH(하면해)", themes: ["love", "career", "study", "money", "health"] },
  {
